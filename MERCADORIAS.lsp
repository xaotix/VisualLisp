...
;
;TRATAMENTOS
(if (= RESULTADO "GALVANIZADO")(setq MENSAGEM2 "SOMENTE PARA PECAS ENCAMINHADAS A GALVANICA. PARA PECAS COM BOBINA ZINCADA, O TRATAMENTO DEVE SER: SEM PINTURA. LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "GALVANIZADO COM JATO")(setq MENSAGEM2 "SOMENTE PARA PECAS QUE SERÃO JATEADAS E DEPOIS ENCAMINHADAS A GALVANICA. PARA PECAS COM BOBINA ZINCADA, O TRATAMENTO DEVE SER: SEM PINTURA. LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "PINTURA LIQUIDA")(setq MENSAGEM2 "LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "PINTURA LIQUIDA 2 DM")(setq MENSAGEM2 "LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "PINTURA LIQUIDA 3 DM")(setq MENSAGEM2 "LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "PINTURA PO")(setq MENSAGEM2 "LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "PINTURA PO 2 DM")(setq MENSAGEM2 "LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "POS PINTURA PO")(setq MENSAGEM2 "SOMENTE PARA PECAS ZINCADAS, GALVANIZADAS, COM BOBINA ZINCADA E QUE DEPOIS SERÃO PINTADAS. LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "POS PINTURA LIQUIDA")(setq MENSAGEM2 "SOMENTE PARA PECAS ZINCADAS, GALVANIZADAS, COM BOBINA ZINCADA E QUE DEPOIS SERÃO PINTADAS. LEMBRE-SE DE FAZER AS FICHAS DE PINTURA"))
(if (= RESULTADO "SEM PINTURA")(setq MENSAGEM2 "SEM PINTURA SELECIONADO."))
;
;TRATAMENTOS
...
(defun pegar_info2 ()
(if (= GALVANIZADO "1")(setq resultado "GALVANIZADO"))
(if (= GALVANIZADO_COM_JATO "1")(setq resultado "GALVANIZADO COM JATO"))
(if (= PINTURA_LIQUIDA "1")(setq resultado "PINTURA LIQUIDA"))
(if (= PINTURA_LIQUIDA_2_DM "1")(setq resultado "PINTURA LIQUIDA 2 DM")	)
(if (= PINTURA_LIQUIDA_3_DM "1")(setq resultado "PINTURA LIQUIDA 3 DM"))
(if (= PINTURA_PO "1")(setq resultado "PINTURA PO"))
(if (= PINTURA_PO_2_DM "1")(setq resultado "PINTURA PO 2 DM"))
(if (= POS_PINTURA_LIQUIDA "1")(setq resultado "POS PINTURA LIQUIDA"))
(if (= POS_PINTURA_PO "1")(setq resultado "POS PINTURA PO"))
(if (= SEM_PINTURA "1")(setq resultado "SEM PINTURA"))
)
(defun obtem_dados1 ()
(setq GALVANIZADO (get_tile "GALVANIZADO"))
(setq GALVANIZADO_COM_JATO (get_tile "GALVANIZADO_COM_JATO"))
(setq PINTURA_LIQUIDA (get_tile "PINTURA_LIQUIDA"))
(setq PINTURA_LIQUIDA_2_DM (get_tile "PINTURA_LIQUIDA_2_DM"))
(setq PINTURA_LIQUIDA_3_DM (get_tile "PINTURA_LIQUIDA_3_DM"))
(setq PINTURA_PO (get_tile "PINTURA_PO"))
(setq PINTURA_PO_2_DM (get_tile "PINTURA_PO_2_DM"))
(setq POS_PINTURA_LIQUIDA (get_tile "POS_PINTURA_LIQUIDA"))
(setq POS_PINTURA_PO (get_tile "POS_PINTURA_PO"))
